...
## Why Pulse? (it's WebSocket — with batteries)
...
### Animated CSV results

Raw numbers (also regenerated by the bench scripts):

[`benchmarks/pulse_results.csv`](benchmarks/pulse_results.csv) ·
[`benchmarks/pulse_hub_results.csv`](benchmarks/pulse_hub_results.csv)

```csv
name,msgs_per_sec,latency_p50_ms,latency_p99_ms
Pulse (Socketify),76600.0,1.6560,1.8490
ws (Node.js),80122.0,1.5760,1.7460
websockets (Python),63511.0,1.9920,2.5830
```
